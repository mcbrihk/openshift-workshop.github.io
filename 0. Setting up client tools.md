...
```sh
# for 64 bit
$ curl -L https://github.com/openshift/origin/releases/download/v1.3.0-alpha.3/openshift-origin-client-tools-v1.3.0-alpha.3-7998ae4-linux-64bit.tar.gz -o openshift-cli.tar.gz

# for 32 bit
$ curl -L https://github.com/openshift/origin/releases/download/v1.3.0-alpha.3/openshift-origin-client-tools-v1.3.0-alpha.3-7998ae4-linux-32bit.tar.gz -o openshift-cli.tar.gz

$ tar -xf openshift-cli.tar.gz --directory ./ --strip-components=1

$ chmod +x oc

$ mv oc /usr/loca/bin/oc
```
