...
```
$ oc new-app https://github.com/VeerMuchandi/time --context-dir=rhel --strategy=docker
```

````
$ oc new-app https://github.com/VeerMuchandi/time --context-dir=busybox  --strategy=docker
...
$ oc get routes
NAME      HOST/PORT                                  PATH      SERVICE   LABELS     TLS TERMINATION
time      time-mycliproject-UserName.apps.devday.ck.osecloud.com             time      app=time   
...
````
$ curl time-mycliproject-UserName.apps.devday.ck.osecloud.com
