...
ks    ks-myjbossapp-Username.apps.cloud.ck.osecloud.com   ks    app=ks        
```
...
$ curl ks-myjbossapp-UserName.apps.cloud.ck.osecloud.com
...
````
Go to https://ks-myjbossapp-Username.apps.cloud.ck.osecloud.com via your browser. Please replace your username with yours.
